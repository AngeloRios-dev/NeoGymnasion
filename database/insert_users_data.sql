...
INSERT INTO NeoGymnasion.users_data (first_names, last_names, email, phone, birth_date, u_address, gender)
VALUES
...
INSERT INTO NeoGymnasion.users_login (fk_user_id, username, u_password, u_role)
